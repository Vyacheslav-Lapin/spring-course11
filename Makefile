...
build:
	./mvnw verify
	chmod +x ./target/spring-course11-0.0.1-SNAPSHOT.jar

run:
	./mvnw spring-boot:run -Dspring.profiles.active=local
#	./target/spring-course11-0.0.1-SNAPSHOT.jar
#	java -jar --enable-preview ./target/spring-course11-0.0.1-SNAPSHOT.jar
...
git-fork-init: init
	git remote add upstream git://github.com/Vyacheslav-Lapin/spring-course11.git
	git fetch upstream
